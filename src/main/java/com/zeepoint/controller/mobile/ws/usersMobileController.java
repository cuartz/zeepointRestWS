...
@RestController
public class usersMobileController extends MobileAppRestController{
	@Autowired
...
//                @RequestParam(value = "email",required = true) String email
	...
	public UserOUT userInfo(
                @RequestParam(value = "name",required = true, defaultValue = "Guest user") String name,
...
//                @RequestParam(value = "email",required = true) String email
		...
		UserOUT user = usersService.saveUser(name, fb_id, gender, email);
		return user;
	}
        
        //saveuser?name=%@&fb_id=%@&gender=%@&email=%@";
}